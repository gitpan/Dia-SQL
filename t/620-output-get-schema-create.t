#   $Id: 620-output-get-schema-create.t 413 2009-02-19 08:33:54Z aff $
...
# 1. parse input
my $db = 'db2';
my $diasql =  Dia::SQL->new( file => catfile(qw(t data TestERD.dia)), db => $db );
...
isa_ok($subclass, 'Dia::SQL::Output')
